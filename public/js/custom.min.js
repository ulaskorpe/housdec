var Acara = (function () {
    ...
    return {
        init: function () {
            ...
            ((a = window.outerHeight) > 0 ? a : screen.height) && $(".content-body").css("min-height", a + 60 + "px"),
                ...
                jQuery(".dz-scroll").each(function () {
                    ...
                    new PerfectScrollbar("#" + e, { wheelSpeed: 2, wheelPropagation: !0, minScrollbarLength: 20 });
                }),
            e <= 991 &&
            ...
            jQuery(".deznav-scroll").length > 0 && new PerfectScrollbar(".deznav-scroll"),
...
jQuery(document).ready(function () {
    $('[data-toggle="popover"]').popover(), Acara.init();
}),
