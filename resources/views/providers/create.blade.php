...
<form class="form-horizontal form-label-left input_mask" id="create-provider"
    ...
    <div class="form-group">
        ...
        <input type="text" value="" placeholder="Adı" name="name" id="name" class="form-control form-control-lg">
    ...
    <div class="form-group">
        ...
        <input type="text" value="" placeholder="Yetkili Kişi" name="contact_person" id="contact_person" class="form-control form-control-lg">
...
<script>
    ...
    $('#create-provider').submit(function (e) {
        ...
        save(formData, '{{route('provider-create-post')}}', '', 'btn-1','');
