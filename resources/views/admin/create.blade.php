...
<form class="form-horizontal form-label-left input_mask" id="create-admin"
    ...
    <div class="form-group">
        <label class="text-black font-w500 w-100">Adı Soyadı:</label>
            ...
            <input type="text" value="" placeholder="Adı Soyadı" name="name_surname" id="name_surname" class="form-control  form-control-lg">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Şifre" disabled name="password" id="password">
            <div class="input-group-append">
                <button type="button" class="btn btn-primary" onclick="generatePassword()" >Şifre Üret</button>
    ...
    <div class="form-group">
        <div class="custom-control custom-checkbox mb-3 checkbox-danger">
            <input type="checkbox" class="custom-control-input" checked id="active" name="active" value="13" >
    ...
    <div class="form-group">
        <div class="custom-control custom-checkbox mb-3 checkbox-danger">
            <input type="checkbox" class="custom-control-input"   id="sudo" name="sudo" value="13" >
            <label class="custom-control-label" for="sudo">Süper Admin</label>
        </div>
...
<script>
    ...
    function generatePassword(){
        $.get("{{url('generate-password')}}/"   , function (data) {
            //   swal(data);
    ...
    $('#create-admin').submit(function (e) {
        ...
        save(formData, '{{route('admin-create-post')}}', '', 'btn-1','');
